...
elseif  length(varargin) == 3 
     ...
     % initial conditions for auxiliary state variables
     mu0 = x_ini(16);  % initial mitigation rate == casadi var
     s0= x_ini(17); %  initial savings rate == casadi var
     % extend
     tau0 =x_ini(18);

end

% extended to add Params.B0 
x0 = [Params.T_AT0 Params.T_LO0 Params.M_AT0 Params.M_UP0 Params.M_LO0 Params.K0 Params.B0]';
...
Net_Economic_Output0 = Damages0 * (1 - tau0)*Gross_Economic_Output0;
