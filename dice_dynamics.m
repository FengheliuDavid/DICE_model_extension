...
Net_Economic_Output = Damages *(1 - tau)*Gross_Economic_Output;
...
B_NEXT = (1 + rbond)^5 * B + 5 * (theta1*(mu^theta2) - tau) * Damages * Gross_Economic_Output;
...
Net_Economic_Output_NEXT = Damages_NEXT *(1 - tau_NEXT)*...
...
%Extended f
f = [i_NEXT; T_NEXT; M_NEXT; K_NEXT; B_NEXT; ...
     sigma_NEXT; L_NEXT; A_TFP_NEXT; E_LAND_NEXT; F_EX_NEXT; ...
     E_NEXT; C_NEXT; mu_NEXT; s_NEXT; tau_NEXT; J_NEXT];